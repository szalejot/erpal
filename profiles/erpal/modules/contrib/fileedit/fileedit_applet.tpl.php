...
<head>
    ...
    <script type="text/javascript">
        ...
        function setConfiguration(downloadUrl, filename, uploadUrl, uploadFieldName, ignoreSslErrors) {
//            if (!isReady) {
//                isReady = isAlive();
//            }
            try {
                document.getElementById("fileHandlerApplet").setConfiguration(downloadUrl, filename, uploadUrl, uploadFieldName, ignoreSslErrors);
            } catch (e) {
                // ignore
            }
